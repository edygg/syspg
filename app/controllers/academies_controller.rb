class AcademiesController < ApplicationController
  ...
  def create
    ...
    @user = User.find_by_id(academy_params[:user_id])
    @user.role = academy_params[:role]
    respond_to do |format|
      if @academy.save && @user.save
  ...
  private
    ...
    def academy_params
      params.require(:academy).permit(:name, :phone, :user_id, :campu_id, :major_id, :role)
    end
end
